...
Mindenekelőtt telepíteni kell az **esptool** alkalmazást. Mivel Python alapú, legelőször a https://www.python.org -ról letöltjük a Pythont. Telepítéskor engedélyezni kell a path hozzáférést. Ezután lehet csak telepíteni az esptool-t, aminek a részletes leírása a következő hivatkozáson érhető el: https://github.com/espressif/esptool .
